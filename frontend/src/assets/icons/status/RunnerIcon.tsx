...
export interface RunnerIconProps extends React.SVGProps<SVGSVGElement> {
 ...
 * Based on the running_man.svg asset — proper running silhouette.
 * Used on the XP progress bar to show level advancement.
 */
export const RunnerIcon: React.FC<RunnerIconProps> = ({
  ...
  >
    {/* Head */}
    <circle cx="13.671" cy="1.905" r="1.905" fill={color} />
    {/* Body + legs in running pose */}
    <path
      d="M17.109,5.454c-0.242-0.289-0.673-0.327-0.962-0.086l-1.894,1.591l-0.871-2.158
